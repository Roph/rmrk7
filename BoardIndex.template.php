...
function template_info_center()
{
	...
	if ($settings['show_stats_index'])
	{
		echo '
			<div class="title_barIC">
				<h4 class="titlebg">
					<span class="ie6_header floatleft">
						<a href="', $scripturl, '?action=stats"><img src="', $settings['images_url'], '/rmrk7/iconic/gray_light/chart_32x32.png" alt="', $txt['forum_stats'], '" /></a>
						', $txt['forum_stats'], '
					</span>
				</h4>
			</div>
	...
	echo $context['show_who'] ? '</a>' : '', '
			...
			<p class="inline smalltext online_list">';
